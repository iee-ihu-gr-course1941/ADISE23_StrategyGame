 ...
 * Θα πρέπει να κοιταξέτε το αρχείο lib/dbconnect.php για τα credentials της βάσης το οποίο να περιέχει:
```
    <?php
	$DB_PASS = '';
	$DB_USER = 'root';
...
- Κανονες Μαχης
- Διαδικασιες για το reset του Board.
...
| `piece`                  | To Πιόνι που υπάρχει στο τετράγωνο           | '1','2','3','4','5', '6', '7','8', '9', 'S', 'B', 'F', null       |
